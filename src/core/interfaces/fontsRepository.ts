...
export type UpdateFonts = (params: FontsRequestParams, body: FontsRequestBody) => Promise<FontsResponse>;
export type DeleteFonts = (params: FontsRequestParams) => Promise<FontsResponse>;
